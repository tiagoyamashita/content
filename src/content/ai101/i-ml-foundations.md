...
- k-Means: 各点を k 個の重心のうち最も近いものに割り当てます。重心を更新します。
...
- 精度 = TP / (TP+FP) — 予測陽性のうち、いくつありますか?
- 想起 = TP / (TP+FN) — 実際の陽性者のうち、何人が捕らえられましたか?
- F1 = 2・P・R / (P+R) — 調和平均。利益と利益のバランスをとる。
- AUC-ROC = ROC 曲線の下の領域。しきい値に依存しないランク品質。

回帰指標:
- MAE = Σ|ŷ−y|/n
- RMSE = √(Σ(ŷ−y)²/n) — 大きなエラーにさらにペナルティを与えます。
...
- L2 正規化ではなく L1 を選択するのはどのような場合ですか?
