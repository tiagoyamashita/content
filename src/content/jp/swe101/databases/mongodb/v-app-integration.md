...
Connect from applications via **official drivers** or ODMs. Examples align with the [Java / Spring Boot](../languages&frameworks/java/springboot/i-intro-and-project-layout.md) and [Python](../languages&frameworks/python/i-basics-and-syntax.md) tracks.
