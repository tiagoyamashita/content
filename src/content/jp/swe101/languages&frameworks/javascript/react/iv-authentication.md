...
Previous: [Rendering & server requests](iii-rendering-and-server-requests.md). Backend patterns: [Spring Security filter chain](../../java/springboot/x-security-basics-and-filter-chain.md).
