...
Previous: [Rendering & server requests](iii-rendering-and-server-requests.md). Web parallel: [React authentication](../react/iv-authentication.md). Backend: [Spring Security](../../java/springboot/x-security-basics-and-filter-chain.md).
