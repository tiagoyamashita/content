...
---
JavaScript — overview
**JavaScript** runs in the browser, on servers (Node.js), and on **mobile** ([React Native](react-native/i-overview.md)). For cross-platform mobile with **Dart**, see [Flutter](../flutter/i-overview.md) (5 parts). For server-rendered HTML with less client JS, see [HTMX](../languages&frameworks/htmx/i-overview.md).
...
| Forms, dashboards, mostly server HTML | **[HTMX](../languages&frameworks/htmx/i-overview.md)** + templates, or **Bootstrap** plugins |
