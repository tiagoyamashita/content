...
See also [htmx overview](../languages&frameworks/htmx/i-overview.md) and [Server responses & templates](../languages&frameworks/htmx/v-server-responses-and-templates.md).
...
Return a fragment when htmx, full `shell` when not — same idea as Thymeleaf branching in [htmx Part V](../languages&frameworks/htmx/v-server-responses-and-templates.md).
...
- [PlantUML — Sequence diagrams](../languages&frameworks/plantuml/iii-sequence-diagrams.md) — diagram syntax used above
- [htmx overview](../languages&frameworks/htmx/i-overview.md) — hypermedia vs SPA
- [htmx — Core attributes & swapping](../languages&frameworks/htmx/iii-core-attributes-and-swapping.md) — `hx-target`, `hx-swap`, triggers
- [htmx — Forms & requests](../languages&frameworks/htmx/iv-forms-and-requests.md) — `hx-post`, form encoding
