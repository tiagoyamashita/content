...
For REST and server-side rendering context, see [REST controllers](../languages&frameworks/java/springboot/iv-rest-controllers.md). For caching static assets vs dynamic HTML, see [CDN](../cdn/i-overview.md).
