...
[Java / Spring Boot](../languages&frameworks/java/springboot/i-intro-and-project-layout.md), [Python](../languages&frameworks/python/i-basics-and-syntax.md), [Postgres](../postgres/i-overview.md), [CDN](../cdn/i-overview.md), [API gateway](../api-gateway/i-overview.md).
