...
**Rule:** Client auth state is **UX** only — [Spring Boot](../languages&frameworks/java/springboot/x-security-basics-and-filter-chain.md) (or any API) must validate every request.
