...
Pin Mermaid version in CI — C4 syntax evolved across releases. For full C4-PlantUML stdlib and pinned includes, see [PlantUML component & deployment](../languages&frameworks/plantuml/iv-component-and-deployment.md).
