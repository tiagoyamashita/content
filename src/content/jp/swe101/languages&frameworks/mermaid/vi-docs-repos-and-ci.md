...
| **Large include trees** | Consider [PlantUML](../languages&frameworks/plantuml/vi-docs-repos-and-ci.md) instead |
...
Both can coexist — pick per doc audience and renderer. See [PlantUML docs, repos & CI](../languages&frameworks/plantuml/vi-docs-repos-and-ci.md) for the Java-side pipeline.
