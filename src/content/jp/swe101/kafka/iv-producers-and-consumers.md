...
Previous: [Core concepts](iii-core-concepts-and-architecture.md). Diagram reference: [PlantUML sequences](../languages&frameworks/plantuml/iii-sequence-diagrams.md).
