...
**Related:** [Patterns & integration](vi-patterns-and-integration.md), [Producers & consumers](iv-producers-and-consumers.md), [Checkout saga](../sysdesign/examples/ii-ecommerce-checkout-saga.md), [Spring Boot REST](../languages&frameworks/java/springboot/iv-rest-controllers.md).
