...
Return to [Kafka overview](i-overview.md). **Sequential workflows:** [Sequential pipelines & sagas](viii-sequential-pipelines-and-sagas.md). Related: [System design examples](../sysdesign/examples/i-overview.md), [PlantUML](../languages&frameworks/plantuml/i-overview.md).
