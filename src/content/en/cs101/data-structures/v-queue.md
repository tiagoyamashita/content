...
<figure class="notes-diagram"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 130" role="img" aria-label="Circular buffer indices wrap with modulo capacity">
  ...
  <text x="12" y="112" fill="#71717a" font-size="9">front / back / size track the logical queue inside the ring — see also iii-foundations.md</text>
</svg></figure>


See **Level III — Foundations** [Foundations](../iii-foundations.md) for another circular-buffer diagram with head/tail labels.
