...
Align with [Docs, repos & CI](../languages&frameworks/mermaid/vi-docs-repos-and-ci.md) (Mermaid) when diagrams live in the same tree.
...
You have the full Obsidian track — pair it with **Git** essentials — [Overview](../git/essentials/i-overview.md) and diagram tracks (**Mermaid** — [Overview](../languages&frameworks/mermaid/i-overview.md)) for a docs workflow that stays in version control.
